      ...
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-md-3 mt-4">
            <div className="icon-box">
              <i
                className="fa-brands fa-css3 fa-2x"
                style={{ color: "#5578ff" }}
              ></i>
              <h3>Css</h3>
            </div>
          ...
          <div className="col-md-3 mt-4">
            <div className="icon-box">
              <i
                className="fa-brands fa-node fa-2x"
                style={{ color: "#3E863B" }}
              ></i>
              <h3>Node.JS</h3>
            </div>
          ...
          <div className="col-md-3 mt-4">
            <div className="icon-box">
              <i
                className="fa-brands fa-git-alt fa-2x"
                style={{ color: "#ff5828" }}
              ></i>
              <h3>Git</h3>
            </div>
            ...
            <div className="col-md-4">
              <div className="testimonial-item text-white">
                <p>
                  ...
                  Md.Mohon has completed a rigorous amountof javascript, HTML,
                  CSS, React. Also completed three projects in React and
                  performed among the top 5% of the class. We found Md. Mohon
                  hard Working, dedicated and quick learner, who can finish the
